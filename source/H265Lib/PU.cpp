 ...
 * @file	PU.cpp
 *
 * @brief	Implementacja klas bloku i jednostki predykcji
 */
...
itsPredictionDone( false )
{
	...
	itsPicRecon = itsParentPicture != NULL ? itsParentPicture->getReconMatrix( itsComp ) : nullptr;
...
PBIntra::~PBIntra( )
{
	deleteMatrix( itsSideReferences );
}
