...
namespace HEVC
{
	...
	Sample **PB::getPredForceRef(Sample* leftRefs, Sample* topRefs, Sample corner)
	{
	...
	int PB::getReferenceValue(const IntraDirection dir, const int offset) const
	{
	...
	void PB::fillMissingReferences(bool** sideAvailable, bool cornerAvailable)
	{
	...
	void PB::calcAndWritePredictionToCU(std::shared_ptr<Pintra> mainPU)
	{
