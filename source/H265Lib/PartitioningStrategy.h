...
{
	/**
	 * @brief	Instancja strategii.
	 */

	static DefaultBigPartitions* instance;

	/**
	 * @fn	DefaultBigPartitions::DefaultBigPartitions( )
	 *
	 * @brief	Konstruktor domyœlny.
	 */
...
public:
	...
	/**
	 * @fn	static DefaultBigPartitions* DefaultBigPartitions::getStrategy( )
	 *
	 * @brief	Dostêp do singletona.
	 *
	 * @return	WskaŸnik na instancjê strategii.
	 */
	...
	/**
	 * @fn	virtual DefaultBigPartitions::~DefaultBigPartitions( )
	 *
	 * @brief	Destruktor.
	 */
	...
	/**
	 * @fn	virtual Void DefaultBigPartitions::doPartitioning( std::shared_ptr<CTU> ctu )
	 *
	 * @brief	Partycjonowanie na poziomie CTU.
	 *
	 * @param	ctu	WskaŸnik na CTU.
	...
	/**
	 * @fn	Void DefaultBigPartitions::doPartitioning( std::shared_ptr<CUQuadTree> CUtree )
	 *
	 * @brief	Partycjonowanie na poziomie drzewa CU.
	 *
	...
	/**
	 * @fn	Void DefaultBigPartitions::doPartitioning( std::shared_ptr<CUIntra> cu )
	 *
	 * @brief	Partycjonowanie na poziomie CU.
	 *
	 * @param	cu	Jednostka kodowa.
	 *
	 * @return	Void.
	 */
	...
	/**
	 * @fn	Void DefaultBigPartitions::doPartitioning( std::shared_ptr<TUQuadTree> TUTree )
	 *
	 * @brief	Partycjonowanie na poziomie drzewa TU.
	 *
	 * @param	TUTree	Drzewo transofrmacji.
	 *
	 * @return	Void.
	 */
	...
	{
		if( TUTree->getSize( ) <= SeqParams( )->getMaxTUSize( ) )
		{
...
/**
 * @class	DefaultSmallPartitions
 *
 * @brief	Strategia ma³ych partycji
 */
...
private:
	...
	/**
	 * @fn	DefaultSmallPartitions::DefaultSmallPartitions( )
	 *
	 * @brief	Konstruktor domyœlny.
	 */
...
public:
	...
	/**
	 * @fn	static DefaultSmallPartitions* DefaultSmallPartitions::getStrategy( )
	 *
	 * @brief	Dostêp do strategii.
	 *
	 * @return	WskaŸnik na strategiê.
	 */
	...
	/**
	 * @fn	virtual DefaultSmallPartitions::~DefaultSmallPartitions( )
	 *
	 * @brief	Destruktor.
	 */
	...
	/**
	 * @fn	Void DefaultSmallPartitions::doPartitioning( std::shared_ptr<CTU> ctu )
	 *
	 * @brief Partycjonowanie na poziomie CTU.
	 *
	 * @param	ctu	WskaŸnik na CTU.
	...
	/**
	 * @fn	Void DefaultSmallPartitions::doPartitioning( std::shared_ptr<CUQuadTree> CUtree )
	 *
	 * @brief	Partycjonowanie na poziomie drzewa CU.
	 *
	 * @param	CUtree	Drzewo jednostek kodowych.
	...
	/**
	 * @fn	Void DefaultSmallPartitions::doPartitioning( std::shared_ptr<CUIntra> cu )
	 *
	 * @brief	Partycjonowanie na poziomie CU.
	 *
	 * @param	cu	CU do podzia³u na jednostki.
	 *
	 * @return	Void.
	 */
	...
	/**
	 * @fn	Void DefaultSmallPartitions::doPartitioning( std::shared_ptr<TUQuadTree> TUTree )
	 *
	 * @brief	Partycjonowanie na poziomie drzewa TU.
	 *
	 * @param	TUTree	Drzewo TU.
	 *
	 * @return	Void.
	 */
...
public:
	...
	{
		LOG( "OPT" ) << "CTU, CUQT(" << CUtree->getX( ) << "," << CUtree->getY( ) << ") " << CUtree->getSize( ) << "x" << CUtree->getSize( ) << std::endl;
		...
		{
			LOG( "OPT" ) << "mozliwe oba tryby" << std::endl;
